# ============================================================================
# Catapult Connect API v6 — Full Data Pull + Stats
#
# Endpoints used:
...
token_env  <- Sys.getenv("CATAPULT_TOKEN")
token      <- if (nzchar(token_env)) token_env else "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImtpZCI6ImU3NzY0MDAzODU1YjlmZWNlOGMxYzIyY2U0YWIxNjlkIn0..tbWBr0gXLhC1rYkTrhOmHswFkJlvbuXJmnexswPl3A18hKPvWWZxgkxXu8mylrmmFsfblVU6vmFtnKj-aRUlkiCjgbJW3m_FyJbInzEkpJqo_0ji0OY62Nuj6Rf3e8M9Y7GREY1YkHGihkO8bVbc_wZvVy5rhD3QARJQO2hi2jVKkJxpmFhRX9Ng-shTjL35YqnyGzBKlzPBY2ZlY0lpA4vrc5L4mvevyt-Bdm0_O2_B6Q3odJvGAdHTft-uPQrbPTSiVOi09gs264MwPvG1otRjuLpD9goV2D_A7Eesdjj-Z-UvNpADmNbaek0bcK4GjP59zTLbf7AMDvsRE4Hs0Od6eC0OtPE67EDj9UuuCesw1-zcgSXaZqbDmnL2ZZZdXt0OiktHKMXm7fjSCYIfNQjjJWADJB5Mrt21R6LjFW_9J_FsI9VcrDs_SdLf-ESTkB9eBv1Hg0yBnfcVCyJbxEdTp5jKbr2Md63D4xVne44790NbP3aWavG_AgjzXDZ_DSHzUXzMQhbi5_qh4iD398vLwYq8zC5TfiBiFNaXMye_PL8HiFr1N792taMXEbXOFMM-4V6wx1BPejpOIA_ViQrjrjUhdM07hd99DDq8lKhllX7ziFg1XdAjIkIXdAg3e1NRCY0pAJ3JuFjkgfwVQ7doPGFra-kG_BD0o_GiKKA"
...
# View key tables in RStudio
# View(activities_df)
# View(parameters_df)
if (interactive()) View(stats_df)

library(writexl)
path_xlsx <- "/Users/mateorodriguez/Desktop/analisis_CA/calculadora_cargas_por_sesion/session-calculator/data/stats_df.xlsx"
write_xlsx(stats_df, path = path_xlsx)

names(stats_df)

# # Search parameters_df by keyword to find the slugs you need
# parameters_df %>%
#   filter(grepl("velocity", slug, ignore.case = TRUE)) %>%
#   select(name, slug) %>%
#   print(n = 1652)

# Try other keywords: "heart_rate", "player_load", "acceleration",
# "sprint", "distance", "meterage", "decel", "ima", "effort"